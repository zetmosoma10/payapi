...
const Footer = () => {
  return (
    <footer className="bg-mirage_blue text-water_white pt-10 pb-14 ">
      <div
        className="max-container flex flex-col items-center space-y-10 
      ...
      >
        ...
        <div className="flex items-center space-x-6 text-2xl">
          <a className=" hover:text-dark_pink transition duration-150" href="">
            <ImFacebook2 />
          </a>
          <a className=" hover:text-dark_pink transition duration-150" href="">
            <FaXTwitter />
